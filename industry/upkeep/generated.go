...
type QueryResolver interface {
	Todos(ctx context.Context) ([]*User, error)
}
...
func (ec *executionContext) field_Mutation_createUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewUser2upkeepᚐNewUser(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNUser2ᚕᚖupkeepᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewUser2upkeepᚐNewUser(ctx context.Context, v interface{}) (NewUser, error) {
...
func (ec *executionContext) marshalNUser2ᚕᚖupkeepᚐUser(ctx context.Context, sel ast.SelectionSet, v []*User) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖupkeepᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
